...
def page_2():
    st.markdown(
        '<div class="header">Features Engineering_</div>', unsafe_allow_html=True
    )
    st.write("""
...
The features files are also available in the [Hugging Face Hub](https://huggingface.co/datasets/mriusero/DeFi-Protocol-Data-on-Ethereum-2023-2024/tree/main/dataset/data).
    ...
    └── features_standardised.arrow      # Contains the 62 features standardized following the process detailed above.
